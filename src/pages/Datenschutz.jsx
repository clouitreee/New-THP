...
const Datenschutz = () => {
  ...
  return (
    <div className="min-h-screen py-20">
      <Seo
        title="Datenschutzerklärung - Tech Hilfe Pro"
        description="Lesen Sie die Datenschutzerklärung von Tech Hilfe Pro. Informationen zur Datenerfassung, -verarbeitung und Ihren Rechten gemäß DSGVO."
        keywords="Datenschutzerklärung, DSGVO, Tech Hilfe Pro, Datenschutz, personenbezogene Daten, Cookies"
        ogUrl="https://techhilfe-ew9dxg.manus.space/datenschutz"
      />
      <div className="container mx-auto px-4">
        <motion.div {...fadeInUp} className="mx-auto max-w-4xl">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h2 className="mt-8 mb-4 text-2xl font-bold">1. Datenschutz auf einen Blick</h2>

            <h3 className="mt-6 mb-3 text-xl font-bold">Allgemeine Hinweise</h3>
            <p>
            ...
            <h3 className="mt-6 mb-3 text-xl font-bold">Datenerfassung auf dieser Website</h3>
            ...
            <h4 className="mt-4 mb-2 text-lg font-semibold">Wie erfassen wir Ihre Daten?</h4>
            <p>
            ...
            <h4 className="mt-4 mb-2 text-lg font-semibold">Wofür nutzen wir Ihre Daten?</h4>
            <p>
            ...
            <h2 className="mt-8 mb-4 text-2xl font-bold">2. Hosting</h2>
            <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>

            <h3 className="mt-6 mb-3 text-xl font-bold">Externes Hosting</h3>
            <p>
            ...
            <h3 className="mt-6 mb-3 text-xl font-bold">Datenschutz</h3>
            <p>
            ...
            <h3 className="mt-6 mb-3 text-xl font-bold">Hinweis zur verantwortlichen Stelle</h3>
            ...
            <p>
              Telefon: +49 155 65029989
              <br />
              E-Mail: info@techhilfepro.de
            </p>

            <h3 className="mt-6 mb-3 text-xl font-bold">Speicherdauer</h3>
            <p>
            ...
            <h3 className="mt-6 mb-3 text-xl font-bold">Auskunft, Löschung und Berichtigung</h3>
            <p>
            ...
            <h2 className="mt-8 mb-4 text-2xl font-bold">4. Datenerfassung auf dieser Website</h2>

            <h3 className="mt-6 mb-3 text-xl font-bold">Kontaktformular</h3>
            <p>
            ...
            <h2 className="mt-8 mb-4 text-2xl font-bold">5. Soziale Medien</h2>

            <h3 className="mt-6 mb-3 text-xl font-bold">WhatsApp</h3>
            <p>
              Auf dieser Website sind Funktionen des Nachrichtendienstes WhatsApp eingebunden.
              Anbieter ist die WhatsApp Ireland Limited, 4 Grand Canal Square, Grand Canal Harbour,
              Dublin 2, Irland.
            </p>
            <p>
              Die Funktion ermöglicht es, direkt über WhatsApp Kontakt mit uns aufzunehmen. Wenn Sie
              die WhatsApp-Funktion nutzen, werden Sie auf die WhatsApp-App oder WhatsApp Web
              weitergeleitet. Dabei können personenbezogene Daten an WhatsApp übermittelt werden.
            </p>

            <h2 className="mt-8 mb-4 text-2xl font-bold">6. Cookies</h2>
            <p>
            ...
            <h2 className="mt-8 mb-4 text-2xl font-bold">7. Ihre Rechte</h2>
            ...
            <p className="text-muted-foreground mt-8 text-sm">Stand: Oktober 2025</p>
          </div>
        </motion.div>
      </div>
    </div>
