      ...
      <div className="container mx-auto px-4">
        <motion.div {...fadeInUp} className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <p>
              Telefon: <a href="tel:+4915565029989" className="text-blue-600 hover:underline">+49 155 65029989</a><br />
              E-Mail: <a href="mailto:info@techhilfepro.de" className="text-blue-600 hover:underline">info@techhilfepro.de</a>
            </p>
            ...
            <p>
              ...
              Zuständige Kammer: [Zuständige IHK]<br />
